# THIS IS A SIMPLE PYTHON PROGRAM WHICH SPLITS THE DATA(WITH PLOTS) FOR ONE YEAR DOWNLOADED FROM "https://cdaweb.gsfc.nasa.gov/index.html/"
...
for DATES1 in DATE_LIST:
    ...
    try:
        ...
        #----------------------------------SECTION 3.1_PLOTTING THE PARAMETERS------------------------------------------
        try:
        ...
        #     for ax in axs:
        #         ax.label_outer()
            FOLDER1 = PATH_TO_DATE_FOLDER + 'STACKED_FIGURES'
            os.makedirs(FOLDER1)
            ...
            GNAME1 = 'PLOT_ON_{}.png'.format(DATES_NEW_FORMAT2)
            GNAME2 = 'PLOT_ON_{}.pdf'.format(DATES_NEW_FORMAT2)
            GNAME3 = 'PLOT_ON_{}.jpeg'.format(DATES_NEW_FORMAT2)
            GNAME4 = 'PLOT_ON_{}.svg'.format(DATES_NEW_FORMAT2)
            GNAME11 = PATH_SUBFOLDER1 + GNAME1
            GNAME21 = PATH_SUBFOLDER2 + GNAME2
            GNAME31 = PATH_SUBFOLDER3 + GNAME3
            GNAME41 = PATH_SUBFOLDER4 + GNAME4
            plt.savefig(GNAME11, dpi=300, bbox_inches='tight')
            plt.savefig(GNAME21, dpi=300, bbox_inches='tight')
            plt.savefig(GNAME31, dpi=300, bbox_inches='tight')
