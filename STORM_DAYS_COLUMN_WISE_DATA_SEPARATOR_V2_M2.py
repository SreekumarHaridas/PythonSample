...
# AND ".txt" FILES
# PARAMETERS IN EACH COLUMNS WILL PLOT IN VERTICALLY STACKED MANNER WITHOUT GAP AND WITH GAP AND SAVING THEM IN FOLDERS STACKED_1 AND STACKED_2
import time
start = time.time()
import shutil
import os
...
with open("INPUT_LOG_STORM_DAYS_COLUMN_WISE_DATA_SEPARATOR_V2_M2.txt", 'w') as f1:
...
# -----------------------------------------ON 07-06-2021---------------------------SREEKUMAR HARIDAS--------------------