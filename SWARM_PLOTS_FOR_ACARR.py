...
axs[0].legend(['Ne','bNe'], frameon=False, loc=0,ncol=3, fontsize=16)
axs2.legend(['Te'], frameon=False, loc=7, fontsize=16)

axs[1].plot(LT,ROD,lw=1.2, color='green', label='ROD')
axs[1].plot(LT,RODI20s,'.',markersize=1,color='red',label='RODI')
axs[1].set_ylabel("ROD, RODI (cm$^{-3}$/s)", fontsize=21, fontweight="bold")
...
axs[1].legend(['ROD','RODI'], frameon=False, loc=0,ncol=3, fontsize=16)

axs[2].plot(LT,mVTEC,'.',markersize=1,color='black',label='mVTEC')
axs[2].plot(LT,aVTEC,'.',markersize=1,color='blue',label='aVTEC')
axs[2].set_ylabel("mVTEC, aVTEC (TECU)", fontsize=21, fontweight="bold")
...
axs[2].legend(['mVTEC','Absolute VTEC'], frameon=False, loc=0,ncol=3, fontsize=16)
...
axs[3].plot(LT,mROTI20s,'.',markersize=1,color='green',label='mROTI20s')
axs[3].set_ylabel("mROT, mROTI (TECU/s)", fontsize=21, fontweight="bold")
...
axs[3].legend(['mROT','mROTI'], frameon=False, loc=6,ncol=3,fontsize=16)
axs[3].margins(x=0)
axs[3].set_ylim(ymin=0.00)
axs[3].set_xlabel('Local Time (IST hours)', fontsize=21, fontweight="bold")
fig.tight_layout()
