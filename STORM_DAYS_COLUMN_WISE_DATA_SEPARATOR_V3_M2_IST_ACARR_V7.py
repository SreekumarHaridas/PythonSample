...
with open("STORM_DAYS_COLUMN_WISE_DATA_SEPARATOR_V3_M2_IST_ACARR_V7.txt", 'w') as f1:
...
try:
    ...
    axs[0].axvline(pd.Timestamp('2021-03-01 04:00:00+05:30'), color='r', linestyle='--', linewidth=3)
    axs[0].margins(x=0)
    ...
    axs[1].axvline(pd.Timestamp('2021-03-01 04:00:00+05:30'), color='r', linestyle='--', linewidth=3)
    axs[1].margins(x=0)
    ...
    axs[2].axvline(pd.Timestamp('2021-03-01 04:00:00+05:30'), color='r', linestyle='--', linewidth=3)
    axs[2].margins(x=0)
    ...
    axs[3].axvline(pd.Timestamp('2021-03-01 04:00:00+05:30'), color='r', linestyle='--', linewidth=3)
    axs[3].margins(x=0)
    ...
    axs[4].axvline(pd.Timestamp('2021-03-01 04:00:00+05:30'), color='r', linestyle='--', linewidth=3)
    axs[4].margins(x=0)
    axs[4].text(.1, 0.8, '(e)', horizontalalignment='left', transform=axs[4].transAxes, fontsize=21,
    ...
    axs[4].axvline(pd.Timestamp('2021-03-01 04:00:00+05:30'), color='r', linestyle='--', linewidth=3)
    axs[4].margins(x=0)
    axs[4].text(.1, 0.8, '(e)', horizontalalignment='left', transform=axs[4].transAxes, fontsize=21, fontweight="bold",
                color='black')
    axs[4].set_xlabel('Date and Time (IST)', fontsize=21, fontweight="bold")
    fig1.tight_layout()
