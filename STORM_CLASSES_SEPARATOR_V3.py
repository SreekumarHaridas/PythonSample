...
with open("INPUT_LOG_STORM_CLASSES_SEPARATOR_V3.txt", 'w') as f1:
...
try:
    ...
    # -------------------------------------------SECTION 3.3 IS OVER----------------------------------------------------
        ...
        plt.yticks(np.arange(minylimit + (-20), maxylimit + 20, 20), np.arange(minylimit + (-20), maxylimit + 20, 20),
        ...
        plt.axhline(y=-100, ls='--', lw=0.5, color='red')
        plt.axhline(y=-50, ls='--', lw=0.5, color='yellow')
        plt.axhline(y=-30, ls='--', lw=0.5, color='green')
        plt.tight_layout()
        ...
        GNAME11 = PATH_TO_FOLDER1 + GNAME1
        GNAME21 = PATH_TO_FOLDER1 + GNAME2
        GNAME31 = PATH_TO_FOLDER1 + GNAME3
        GNAME41 = PATH_TO_FOLDER1 + GNAME4
