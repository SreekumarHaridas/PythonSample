...
axs[0].plot(LATITUDE,NE,linestyle='-',lw=2,color='red',label='N$_{e}$')
axs[0].plot(LATITUDE,bNE,linestyle='-',lw=2,color='black',label='bN$_{e}$')
axs[0].set_ylabel("N$_{e}$ (cm$^{-3}$)\n", fontsize=32, fontweight="bold")
...
axs[0].text(.9, 0.8, '(a)',horizontalalignment='left', transform= axs[0].transAxes, fontsize=28, fontweight="bold", color='black')
axs[0].axvline(x=10.04, color='r', linestyle='--', linewidth=3)
axs[0].margins(x=0)
axs[0].legend(frameon=False, loc=0,ncol=3, fontsize=28,markerscale=15)
axs[1].plot(LATITUDE,Te,linestyle='-',lw=2,color='blue',label='T$_{e}$')
axs[1].set_ylabel("T$_{e}$ (K)", fontsize=32, fontweight="bold")
...
axs[1].text(.9, 0.8, '(b)',horizontalalignment='left', transform= axs[1].transAxes, fontsize=28, fontweight="bold", color='black')
axs[1].axvline(x=10.04, color='r', linestyle='--', linewidth=3)
axs[1].margins(x=0)
axs[1].set_ylim(ymin=500, ymax=3900)
axs[1].legend(frameon=False, loc='upper left',ncol=3, fontsize=28,markerscale=15)
for PRNNEW in PRNLIST: 
    ...
    axs[2].text(.9, 0.8, '(c)',horizontalalignment='left', transform= axs[2].transAxes, fontsize=28, fontweight="bold", color='black')
    axs[2].axvline(x=10.04, color='r', linestyle='--', linewidth=3)
    axs[2].margins(x=0)
